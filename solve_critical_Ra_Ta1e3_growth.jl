...
ks_uv_tfbf_b_tvbv = 3:0.01:10
res_Ra_k_uv_tfbf_b_tvbv, fig_uv_tfbf_b_tvbv, A_uv_tfbf_b_tvbv, A_eigen_uv_tfbf_b_tvbv, k′_uv_tfbf_b_tvbv, m′s_uv_tfbf_b_tvbv = find_plot_critical_Ra_k_A_ω(
    bcs_type_uv_tfbf_b_tvbv, ms_eq, ks_uv_tfbf_b_tvbv, ω, Ta, Pr; Ra_min=100, Ra_max=1e4)

compute_coefficients_ω(k′_uv_tfbf_b_tvbv, ω, m′s_uv_tfbf_b_tvbv, Ra=res_Ra_k_uv_tfbf_b_tvbv.minimum, Ta=Ta, Pr=Pr, ρ₀=ρ₀, H=H, ν=ν)

A = build_bc_matrix_ω(3.71, -im*0.1, bcs_type_uv_tfbf_b_tvbv, ms_eq, Ta, Pr, 2695.7, ν=1, H=1, ρ₀=1000)
logabsdet(A)
logabsdet(A_uv_tfbf_b_tvbv)
...
ks_uv_tfbf_b_tfbf = 0.01:0.1:5

res_Ra_k_uv_tfbf_b_tfbf, fig_uv_tfbf_b_tfbf, A_uv_tfbf_b_tfbf, A_eigen_uv_tfbf_b_tfbf, k′_uv_tfbf_b_tfbf, m′s_uv_tfbf_b_tfbf = find_plot_critical_Ra_k_A_ω(
    bcs_type_uv_tfbf_b_tfbf, ms_eq, ks_uv_tfbf_b_tfbf, ω, Ta, Pr; Ra_min=1000, Ra_max=2e3)
